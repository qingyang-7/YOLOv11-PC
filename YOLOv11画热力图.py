...
def get_params():
    params = {
        'weight': r'E:\yolo\ultralytics-main\yolov11\runs\V11train\exp\weights\best.pt',  # 训练出来的权重文件
        'cfg': r'E:\yolo\ultralytics-main\yolov11\ultralytics\cfg\models\addv11\yolov11n_C3k2_IEL.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
        'method': 'GradCAM',
...
if __name__ == '__main__':
    ...
    model(r'E:\yolo\ultralytics-main\yolov11\ultralytics\assets\bus.jpg', 'result/v11')  # 第一个是检测的文件, 第二个是保存的路径