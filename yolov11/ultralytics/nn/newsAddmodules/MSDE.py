...
# class DetailEnhancement(nn.Module):
    def __init__(self, img_dim, feature_dim):
        super(MsDE,self).__init__()
        norm = nn.BatchNorm2d
        act = nn.ReLU
    ...
    def forward(self, data):
        #data[0]的尺寸是data[1]和data[2]的两倍
        img, feature, b_feature = data[0],data[1],data[2]
...
#     msde =MsDE(img_dim=128,feature_dim=512)
#     input = torch.randn(1, 128, 128, 128)
#     feature = torch.randn(1, 512, 32, 32)
#     b_feature = torch.randn(1, 512, 32, 32)
#     # 执行前向传播
