...
__all__=['C2f_DEConv','C2f_DEConv_2','DEConv']
# --------------------------------------------------------
...
class C2f_DEConv(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(DEConv(self.c) for _ in range(n))

class C2f_DEConv_2(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(DEConv_2(self.c) for _ in range(n))
