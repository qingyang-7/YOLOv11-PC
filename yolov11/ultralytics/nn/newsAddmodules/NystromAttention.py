...
__all__=['Nystromattention','C3k2_Nystromattention','C2f_Nystromattention']
...
class Nystromattention(nn.Module):
    ...
    def forward(self, x):
        ...
        if return_attn:
            ...
            return out, attn
        out = out.reshape(b1,h1,w1,c1).permute(0,3,1,2)
        return out
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        ...
        self.Attention = Nystromattention(c2)
...
class C2f_Nystromattention(nn.Module):
...
class C3k2_Nystromattention(C2f_Nystromattention):
    """Faster Implementation of CSP Bottleneck with 2 convolutions."""
...
if __name__ == '__main__':
    ...
    model = C3k2_Nystromattention(64,128)
